...
import (
	...
	"github.com/jonathannavas/gocourse_course/pkg/bootstrap"
	"github.com/jonathannavas/gocourse_course/pkg/handler"
)
...
func main() {
	...
	h := handler.NewUserHTTPServer(ctx, course.MakeEndpoints(courseService, course.Config{LimitPageDef: pagLimitDef}))
